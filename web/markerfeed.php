...
$sql_statement = "SELECT BLDG_NAME,TYPE,STATUS,HSE_NO,STREET,CITY_MUNIC FROM namria WHERE HSE_NO NOT LIKE 'NO HOUSE NUMBER%' AND CITY_MUNIC LIKE '%MANILA%' ORDER BY id";
